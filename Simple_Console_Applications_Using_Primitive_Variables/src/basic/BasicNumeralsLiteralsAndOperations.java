...
public class BasicNumeralsLiteralsAndOperations {
	...
	public static void main(String[] args) {
		...
		System.out.println(4 * (15 / 4) + (15 % 4)); // 15 rather than 18
		System.out.println(4 * (15.0 / 4) + (15 % 4)); // 18, the expected result
