...
public class RefactoredLab2Tests {
	@Rule
	...
	public void test_01_01_() {
		...
		int n = RefactoredLab2.digitCountinString(str);
		int expect = 3;
	...
	public void test_02_01_() {
		...
		String result = RefactoredLab2.stringOfRandomInt(n,x,y);
	...
	public void test_03_01_() {
		...
		int result = RefactoredLab2.lengthofMaxConsecutiveZeros(n);
		int expect = 3;
		String str = String.format(
	...
	public void test_04_01_() {
		...
		String result = RefactoredLab2.mixStrings(s1, s2, s3);
	...
	public void test_05_01_() {
		...
		String result = RefactoredLab2.stringCompressor(inputStr);
	...
	public void test_06_01_() {
		short x=122;
		String result= RefactoredLab2.binaryRepresentation(x);
	...
	public void test_07_01_() {
		int x=150, y=156;
		String result= RefactoredLab2.countofMult357(x,y);
	...
	public void test_08_01_() {
		final int n = 16;
		String  result = RefactoredLab2.isPalindromeInt(n);
	...
	public void test_09_01_() {
		...
		String result= RefactoredLab2.binaryXor(v1, v2);
